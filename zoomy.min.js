...
b.attr("src")).one("load",function(){u.zoom(a,c.count.length)}).each(function(){(this.complete||e.browser.msie&&6===parseInt(e.browser.version,10))&&e(this).trigger("load")})}};"object"===typeof g&&void 0===d?(d=g,g=q):void 0===g&&(g=q);d=e.extend({zoomSize:200,round:!0,glare:!0,clickable:!1,attr:"href",border:"5px solid rgba(145, 192, 255, 0.65)",zoomInit:null,zoomStart:null,zoomStop:null},d);e(this).each(function(){var a=e(this),b=a.find("img");u.init(a,b)})}})(jQuery);